({
    ...
    updateSelected: function(component, event, helper) {
        ...
        if(! Array.isArray(getAllId)){
            ...
            // if value is checked(true) then add those Id (store in Text attribute on checkbox) in updateId var.
            for (var i = 0; i < getAllId.length; i++) {
        ...
        helper.updateSelectedHelper(component, event, updateId);
